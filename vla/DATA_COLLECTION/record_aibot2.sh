...
# ---------- Dataset settings ----------
DATASET_REPO_ID="${LEROBOT_DATASET_REPO_ID:-ases200q2/Aibot2_test}"
DATASET_ROOT="${LEROBOT_DATASET_ROOT:-${HOME}/lerobot_datasets/Aibot2_test}"
SINGLE_TASK="${LEROBOT_SINGLE_TASK:-Pick object from table}"
NUM_EPISODES="${LEROBOT_NUM_EPISODES:-3}"
...
export LEROBOT_CAMERA_2_TOPIC="${LEROBOT_CAMERA_2_TOPIC:-/camera/camera_top/color/image_raw/compressed}"
