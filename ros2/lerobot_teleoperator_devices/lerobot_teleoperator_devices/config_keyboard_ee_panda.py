...
@KeyboardEndEffectorTeleopConfig.register_subclass("keyboard_ee_panda")
@dataclass
class KeyboardEEPandaTeleopConfig(KeyboardEndEffectorTeleopConfig):
    """Configuration for keyboard-based Panda end-effector control."""
